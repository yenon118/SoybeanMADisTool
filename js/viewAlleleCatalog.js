...
function queryAllCountsByGeneChromosomePositions(dataset, gene, chromosome, position_array_string) {
	let position_array = position_array_string.split(";");
...
function queryAllByGeneChromosomePositions(dataset, gene, chromosome, position_array_string) {
	let position_array = position_array_string.split(";");
